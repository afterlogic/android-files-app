...
import com.afterlogic.aurora.drive.core.util.ApiCompatibilityUtil;
import com.afterlogic.aurora.drive.core.util.FileUtil;
import com.afterlogic.aurora.drive.core.util.Holder;
    ...
    public static class FileSyncAdapter extends AbstractThreadedSyncAdapter {
        ...
        private boolean updateCredentials() throws IOException {
            ...
            mApi.getUserRepository()
                    ...
                    .subscribe(
                            token -> credentialResult.setValue(true),
                            error -> MyLog.majorException(this, error)
                    );
            return credentialResult.getValue();
        }
