package com.afterlogic.aurora.drive.data.modules.project7.modules.user.repository;
...
public class UserRepositoryP7Impl extends BaseRepository implements UserRepository {
    ...
    @Inject UserRepositoryP7Impl(@RepositoryCache ObservableCache cache, AuthServiceP7 authService, SessionManager sessionManager) {
