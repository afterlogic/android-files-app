...
import com.afterlogic.aurora.drive.core.util.DialogUtil;
import com.afterlogic.aurora.drive.core.util.DownloadType;
import com.afterlogic.aurora.drive.core.util.FileUtil;
import com.afterlogic.aurora.drive.core.util.IntentUtil;
import com.afterlogic.aurora.drive.core.util.WatchingFileManager;
import com.afterlogic.aurora.drive.core.util.task.TaskProgressNotifier;
...
import com.afterlogic.aurora.drive.presentation.receivers.SyncResolveReceiver;
import com.afterlogic.aurora.drive.presentation.services.FileLoadService;
import com.afterlogic.aurora.drive.presentation.services.SyncService;
import com.afterlogic.aurora.drive.presentation.ui.common.base.BaseFileDownloadActivity;
import com.afterlogic.aurora.drive.presentation.ui.common.views.SelectionEditText;
    ...
    protected void showRenameDialog(final AuroraFile file){
        ...
        DialogUtil.showInputDialog(
                ...
                (dialogInterface, input) -> {
                    ...
                    //Check new name if it is same as old close dialog without any action
    ...
    private void checkRenameFile(final AuroraFile oldFile, final AuroraFile newFile){
        int taskId = Api.checkFile(newFile, new ApiCallback<AuroraFile>() {
            ...
            public void onSucces(AuroraFile result) {
                new AlertDialog.Builder(BaseFileActionActivity.this, R.style.Dialog)
