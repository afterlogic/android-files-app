package com.afterlogic.aurora.drive.data.modules.project8.modules.user.repository;
...
public class UserRepositoryP8Impl extends BaseRepository implements UserRepository {
    ...
    @Inject public UserRepositoryP8Impl(@RepositoryCache ObservableCache cache, AuthServiceP8 authService, SessionManager sessionManager) {
