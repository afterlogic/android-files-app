...
import com.afterlogic.aurora.drive.presentation.ui.fragments.FileViewCallback;
import com.afterlogic.aurora.drive.presentation.ui.fragments.FileViewFragment;
    ...
    protected void onFileDownloaded(final AuroraFile file, final File result, DownloadType downloadType) {
        ...
        switch (downloadType){
            case DOWNLOAD_TO_DOWNLOADS:
                new AlertDialog.Builder(FileViewActivity.this, R.style.Dialog)
